        ...
        <div className={styles.karuzela}>
            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" >
                <ol className="carousel-indicators">
                    ...
                    <li data-target="#carouselExampleIndicators" data-slide-to="3" draggable="false"></li>
                </ol>
                <div className="carousel-inner" id={styles.karuzelacenter}>
                    ...
                    <div className="carousel-item" >
                        <img className={styles.d_block} src={karuzela1} alt="Second slide" draggable="false"/>
                    </div>
                    <div className="carousel-item" >
                        <img className={styles.d_block} src={karuzela2} alt="Third slide" draggable="false"/>
                    </div>
                    <div className="carousel-item" >
                        <img className={styles.d_block} src={karuzela3} alt="Fourth slide" draggable="false"/>
                    </div>
                </div>
